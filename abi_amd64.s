...
// DI (RDI) points at abiCallFrame; we marshal up to 5 integer/pointer args
...
TEXT abiCallTrampoline(SB), NOSPLIT, $32
...
TEXT abiCallPtrLenTrampoline(SB), NOSPLIT, $32
	MOVQ BX, 8(SP)         // save callee-saved BX
	MOVQ R12, 16(SP)       // save callee-saved R12
...
TEXT abiCallFloatTrampoline(SB), NOSPLIT, $32
	MOVQ BX, 8(SP)         // save callee-saved BX
	MOVQ R12, 16(SP)       // save callee-saved R12
	MOVQ DI, R12           // save frame ptr
