...
require (
	...
	github.com/stoolap/stoolap-go v0.0.0
)

require (
	github.com/stoolap/stoolap-go/lib/darwin_arm64 v0.0.0 // indirect
	github.com/stoolap/stoolap-go/lib/linux_amd64 v0.0.0 // indirect
	github.com/stoolap/stoolap-go/lib/windows_amd64 v0.0.0 // indirect
)
