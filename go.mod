...
require (
	github.com/stoolap/stoolap-go/lib/darwin_arm64 v0.4.1
	github.com/stoolap/stoolap-go/lib/linux_amd64 v0.4.1
	github.com/stoolap/stoolap-go/lib/windows_amd64 v0.4.1
)
